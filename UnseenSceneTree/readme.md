Gmap Tree Describer:
	...
	Gmap Tree Describer is an accessibility addon for the Unseen Godot project, which annotates every Tree control in the editor with depth and expand/collapse state so screen readers have more context when navigating.
